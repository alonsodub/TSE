...
/* Definitions for driver FPU */
#define XPAR_FPU_NUM_INSTANCES 1

/* Definitions for peripheral FPU_0 */
#define XPAR_FPU_0_DEVICE_ID 0
#define XPAR_FPU_0_BASEADDR 0xFFFE8000
#define XPAR_FPU_0_HIGHADDR 0xFFFEFFFF
