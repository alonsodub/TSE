------------------------------------------------------------------------------
-- fpu.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library rdpfifo_v4_00_a;
use rdpfifo_v4_00_a.rdpfifo_top;

library wrpfifo_v4_00_a;
use wrpfifo_v4_00_a.wrpfifo_top;

library plbv46_slave_single_v1_00_a;
use plbv46_slave_single_v1_00_a.plbv46_slave_single;

library fpu_v1_00_a;
use fpu_v1_00_a.user_logic;
...
architecture IMP of fpu is
  ...
  ------------------------------------------
  -- Write FIFO data realignment engine (DRE) inclusion/omision
  -- 1 = include DRE
  -- 0 = omit DRE
  ------------------------------------------
  constant WFF_INCLUDE_DRE                : integer              := 0;
...
begin
  ...
  ------------------------------------------
  RDPFIFO_TOP_I : entity rdpfifo_v4_00_a.rdpfifo_top
    generic map
    (
  ...
  ------------------------------------------
  WRPFIFO_TOP_I : entity wrpfifo_v4_00_a.wrpfifo_top
    generic map
    (
      C_OPB_PROTOCOL                 => false,
      C_MIR_ENABLE                   => false,
  ...
  ------------------------------------------
  USER_LOGIC_I : entity fpu_v1_00_a.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "01000" => ipif_IP2Bus_Data <= rff_IP2Bus_Data;
      when "00100" => ipif_IP2Bus_Data <= rff_IP2Bus_Data;
      when "00010" => ipif_IP2Bus_Data <= wff_IP2Bus_Data;
      when "00001" => ipif_IP2Bus_Data <= wff_IP2Bus_Data;
      when others => ipif_IP2Bus_Data <= (others => '0');
    end case;

  end process IP2BUS_DATA_MUX_PROC;

  ipif_IP2Bus_WrAck <= user_IP2Bus_WrAck or rff_IP2Bus_WrAck or wff_IP2Bus_WrAck;
  ipif_IP2Bus_RdAck <= user_IP2Bus_RdAck or rff_IP2Bus_RdAck or wff_IP2Bus_RdAck;
  ipif_IP2Bus_Error <= user_IP2Bus_Error or rff_IP2Bus_Error or wff_IP2Bus_Error;
