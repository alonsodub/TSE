...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/alonso/Linux-on-FPGA/Hardware/BaseSystem
  logical library name                       : fpu_v1_00_a
  top name                                   : fpu
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
Address Block for User Logic and IPIF Predefined Services
  ...
  read fifo register space                   : C_BASEADDR + 0x00000100
  (RdFIFO Reset/MIR, RdFIFO Status)          : C_BASEADDR + 0x000001FF
  read fifo data space                       : C_BASEADDR + 0x00000200
                                             : C_BASEADDR + 0x000002FF
  write fifo register space                  : C_BASEADDR + 0x00000300
  (WrFIFO Reset/MIR, WrFIFO Status)          : C_BASEADDR + 0x000003FF
  write fifo data space                      : C_BASEADDR + 0x00000400
...
rdpfifo_v4_00_a
	/opt/Xilinx/10.1/EDK/hw/XilinxProcessorIPLib/pcores/rdpfifo_v4_00_a/doc/rdpfifo.pdf

dre_v2_00_a
	No documentation for this library

wrpfifo_v4_00_a
	/opt/Xilinx/10.1/EDK/hw/XilinxProcessorIPLib/pcores/wrpfifo_v4_00_a/doc/wrpfifo.pdf
